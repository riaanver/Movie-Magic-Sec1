...
const LoginPage = () => {
  ...
  return (
    <div className="mx-auto max-w-md rounded-2xl border border-[color:var(--border-strong)] bg-[color:var(--surface-1)] p-6 shadow-sm">
      <h1 className="text-2xl font-semibold text-[color:var(--text-primary)]">Sign in</h1>
      <p className="text-sm text-[color:var(--text-secondary)]">Access your personalised watchlist.</p>
